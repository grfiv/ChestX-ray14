...
| ------------------ | ----------- | -------------- | --------------------- | ------------ | ---------- |
| Cardiomegaly       | **0.906**   | 0.924          | 0.896                 | 0.922        | 0.920      |
| Emphysema          | 0.889       | 0.937          | 0.820                 | 0.935        | 0.870      |
| Effusion           | **0.889**   | 0.887          | 0.820                 | 0.810        | 0.840      |
| Edema              | 0.890       | 0.927          | 0.820                 | 0.850        | 0.860      |
| Pneumothorax       | 0.889       | 0.888          | 0.890                 | 0.850        | 0.870      |
| Hernia             | 0.883       | 0.916          | 0.840                 | 0.936        | 0.850      |
| Mass               | 0.829       | 0.848          | 0.867                 | 0.820        | 0.830      |
| Fibrosis           | 0.827       | 0.804          | 0.810                 | 0.780        | 0.810      |
| Consolidation      | 0.829       | 0.893          | 0.810                 | 0.790        | 0.830      |
| Atelectasis        | 0.811       | 0.809          | 0.810                 | 0.820        | 0.850      |
| Pleural Thickening | 0.767       | 0.806          | 0.810                 | 0.790        | 0.820      |
| Nodule             | **0.771**   | 0.780          | 0.655                 | 0.760        | 0.700      |
| Pneumonia          | 0.748       | 0.768          | 0.770                 | 0.810        | 0.800      |
| Infiltration       | 0.716       | 0.734          | 0.730                 | 0.700        | 0.750      |
...
3. Using a 'toy' model I tested 18 loss functions and settled on DynamicWeightedBCE_wgt_smooth which produced the best results.
4. Finally, I set about testing the entire dataset with all 14 diseases on a 'real' model, modifying it until I achieved the results above.
...
3. **Batch Size Considerations**
   - <u>Use sufficiently large batch sizes (32 or larger)</u>
